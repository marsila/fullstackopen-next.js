...
3. [Create new](/create) to create a new blog post
...
Source code [https://github.com/marsila/fullstackopen-next.js](https://github.com/marsila/fullstackopen-next.js)