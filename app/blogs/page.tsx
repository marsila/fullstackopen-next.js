    ...
    <div>
      ...
      <form action="/blogs">
        <label htmlFor="filter">
          ...
          <input type="text" name="filter" id="filter" defaultValue={filter} data-testid="filter-input"/>
        </label>
        <button type="submit" className="submit-btn" data-testid="search-button">Filter</button>
      ...
      {blogs.length === 0 ? (
        ...
        <ul className="divide-y divide-gray-100" data-testid="blogs-list">
          {blogs
